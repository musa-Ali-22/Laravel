...
<form method="post" action="{{url('submit')}}" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    ...
    <input type="Number" class="form-control" name="phonenumber" id="exampleInputEmail1" aria-describedby="emailHelp">
    @error('phonenumber')
    <p>{{$message}}</p>
    @enderror
  </div>
  <div class="mb-3">
    ...
    <input type="File" class="form-control" name="imagefile" id="exampleInputEmail1" aria-describedby="emailHelp">
    @error('imagefile')
    <p>{{$message}}</p>
    @enderror
  </div>
